...
void ModeManualK::update()
{
    ...
    /*GCS_SEND_TEXT(MAV_SEVERITY_INFO, "d1_angel_motor: %f", zefiroControl.d1_angel_motor);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "d2_angel_motor: %f", zefiroControl.d2_angel_motor);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "d3_angel_motor: %f", zefiroControl.d3_angel_motor);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "d4_angel_motor: %f", zefiroControl.d4_angel_motor);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "=======");*/
    ...
    /*GCS_SEND_TEXT(MAV_SEVERITY_INFO, "ang1: %d", output_d1_angel);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "ang2: %d", output_d2_angel);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "ang3: %d", output_d3_angel);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "ang4: %d", output_d4_angel);
    GCS_SEND_TEXT(MAV_SEVERITY_INFO, "====");*/
    ...
    */
    ...
    /*SRV_Channels::move_servo(SRV_Channel::k_mount2_roll, output_d1_angel, angle_min, angle_max);
    SRV_Channels::move_servo(SRV_Channel::k_mount2_tilt, output_d2_angel, angle_min, angle_max);
    //SRV_Channels::move_servo(SRV_Channel::k_mount2_roll, output_d3_angel, angle_min, angle_max);
    SRV_Channels::move_servo(SRV_Channel::k_mount2_pan, output_d4_angel, angle_min, angle_max);*/
